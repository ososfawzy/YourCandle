        ...
        public ViewHolder(View itemView) {
            ...
            textViewName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ttsManager.speakMessage("Share Audio Using",utteranceId);
                    Intent shareIntent = new Intent(Intent.ACTION_SEND);
                    File root = android.os.Environment.getExternalStorageDirectory();
                    String path = root.getAbsolutePath()+"/VoiceRecorder/Audios/";
                    String recordingUri = path + textViewName.getText();
                    Uri audioUri = Uri.parse(recordingUri);
                    shareIntent.setType("audio/mp3");
                    shareIntent.putExtra(Intent.EXTRA_STREAM,audioUri);
                    context.startActivity(Intent.createChooser(shareIntent,"Share Audio Using"));
                }
            });
